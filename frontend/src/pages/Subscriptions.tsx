      ...
      <div className="bg-[#0B4D26] text-white py-16 md:py-24">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/shop" className="bg-[#C9A227] hover:bg-[#b08d20] text-gray-900 font-bold px-8 py-4 rounded-full transition-transform hover:scale-105">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-10 bg-[#0B4D26] text-white relative overflow-hidden">
                ...
                <Link to="/shop" className="block w-full bg-white text-[#0B4D26] text-center font-bold py-4 rounded-lg hover:bg-gray-100 transition-colors">
                  Start Subscription
                </Link>
              </div>
            </div>
