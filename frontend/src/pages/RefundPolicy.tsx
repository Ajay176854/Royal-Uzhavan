      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
          <div className="space-y-4 text-gray-700">
            ...
            <p>Refunds will be processed within 5-7 business days if your claim for a damaged or incorrect item is approved. The refund will be credited back to your original payment method.</p>
            <h3 className="text-xl font-bold text-gray-900 mt-6">3. Cancellations</h3>
            <p>Orders can be cancelled before they are dispatched for a full refund. Once dispatched, orders cannot be cancelled.</p>
          </div>
        </div>
      </div>
    </div>
