        ...
        <div className="container mx-auto px-4 md:px-12">
          ...
          >
            {PRODUCT_CATEGORIES[activeTab].map((item, i) => (
              ...
              >
                <Link href={item.to || `/shop?category=${encodeURIComponent(item.title)}`} className="group flex flex-col items-center text-center">
        ...
        <section className="py-24 relative border-t border-[var(--color-wabi-earth)]/10 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-12 relative z-10">
            ...
            >
              ...
              <Link href="/shop" className="hidden md:inline-flex items-center gap-2 font-bold text-white text-xs uppercase tracking-widest hover:text-gray-200 transition-colors mt-4 md:mt-0 border-b border-transparent hover:border-white pb-1 drop-shadow-md">
            ...
            >
              <Link href="/shop" className="inline-flex items-center gap-2 bg-[var(--color-wabi-bg)] text-[var(--color-wabi-green)] font-bold px-8 py-4 rounded-full text-sm">
                View All Products
              </Link>
            </motion.div>
          </div>
        ...
        <section className="py-20 lg:py-24 bg-[var(--color-wabi-bg)] border-y border-[var(--color-wabi-earth)]/10">
          <div className="container mx-auto px-4 md:px-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              <Link href="/shop" className="inline-flex items-center gap-2 bg-[var(--color-wabi-green)] text-white font-bold px-8 py-4 rounded-full text-xs uppercase tracking-widest">
