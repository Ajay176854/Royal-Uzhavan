  ...
  return (
    <div className="bg-[var(--color-wabi-bg)] min-h-screen">
      ...
      <div className="container mx-auto px-4 md:px-12 py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 text-center mb-32 max-w-5xl mx-auto">
          <div className="p-6 md:p-8 lg:p-12 bg-[#EAE5D9] border border-[var(--color-wabi-earth)]/20 rounded-3xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[var(--color-wabi-green)] mb-4 sm:mb-6 italic">100%</h3>
          ...
          <div className="p-6 md:p-8 lg:p-12 bg-[#EAE5D9] border border-[var(--color-wabi-earth)]/20 rounded-3xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[var(--color-wabi-green)] mb-4 sm:mb-6 italic">KK</h3>
          ...
          <div className="p-6 md:p-8 lg:p-12 bg-[#EAE5D9] border border-[var(--color-wabi-earth)]/20 rounded-3xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[var(--color-wabi-green)] mb-4 sm:mb-6 italic">Free</h3>
            <h4 className="font-bold text-[10px] sm:text-xs uppercase tracking-widest text-[var(--color-wabi-earth)] mb-2 sm:mb-3">Delivery</h4>
            <p className="text-gray-500 text-[11px] sm:text-sm leading-relaxed">Enjoy free delivery all around the Kanyakumari district.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[var(--color-wabi-green)] text-center py-24 px-4 relative overflow-hidden">
        ...
        <Link href="/shop" className="relative z-10 inline-block bg-[var(--color-wabi-gold)] hover:bg-[#a68636] text-white px-10 py-4 font-bold text-xs uppercase tracking-widest rounded-full transition-all shadow-sm">
          Explore Our Feed
        </Link>
      </div>
    </div>
